...
@export var rock_attack_object_spawner_spawner : Node
@export var rock_spin_attack_object : PackedScene
...
func spawn_attack():
	if chosen_attack == "Spinning Rock":
		spinner.add_child_with_offset(rock_spin_attack_object)
	elif chosen_attack == "Thrown Rock":
		rock_attack_object_spawner_spawner.create_child()
